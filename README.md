...
A comprehensive task management application built with Remix.js for managing tasks, projects, and ideas.

## Features

- ✅ Task management (add, complete, archive, delete)
- 📝 Add comments to tasks
- 📂 Project organization with mind maps
- 📊 Dashboard with analytics
- 📒 Notes for tracking ideas
...
3. Set up the local domain mapping (requires sudo access):

```bash
./setup-local-domain.sh
```

This script adds todo.com to your hosts file, pointing to 127.0.0.1.
...
The app will be accessible at http://todo.com:1212

## Project Structure

- `app/` - Main application code
  - `components/` - UI components 
  - `models/` - Data models and persistence layer
